...
<div class="row" style="width:100%; background-color: rgba(96, 96, 112, 0.85); border-radius: 15px;">
    ...
    <div class="col-md-1" style="height: 8em;min-width: 11em;max-width: 15%;display: flex;flex-wrap: wrap;justify-content: space-between;">
        <p style="display: flex;flex-wrap: wrap;justify-content: space-between;width:100%;margin:0;font-size: 1.7em;color: whitesmoke;font-weight: bold;"><?=$discordUserName ?></p>
